...
<head>
  ...
  <meta property="og:image"         content="{{asset('uploads/'.$articles[0]->image)}}" />
    @elseif(!empty($articles[0]->video_url))
  <meta property="og:video" content="{{$articles[0]->video_url}}"/>
  <meta property="og:url"  content="{{$articles[0]->video_url}}"/>
  ...
  <meta property="og:description"   content='{!! str_limit(strip_tags($articles[0]->content), $limit = 200, $end = '...') !!}' />

function convert_to_unicode(legacy_text)
{
	...
	while(chale_chalo==1)
	{
		...
		if(sthiti2<(text_size- max_text_size))
		{
			...
			while(legacy_text.charAt(sthiti2)!=' '){
				sthiti2--;
			}
		}
		else{
...
function Replace_Symbols()
{
	...
	modified_substring=modified_substring.replace(charecter_to_be_replaced,new_replacement_string);position_of_R=modified_substring.indexOf("{");
	}
